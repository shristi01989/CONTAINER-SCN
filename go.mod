module github.com/aquasecurity/containerscn
...
require (
	...
	github.com/aquasecurity/containerscn-db v0.0.0-20220627104749-930461748b63
	github.com/aquasecurity/containerscn-kubernetes v0.3.1-0.20220727123250-2cfd49c5b6c3
